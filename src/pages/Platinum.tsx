...
interface PlatinumAsset {
  id: string;
  particulars: string;
  value: number;
}

const initialAssets: PlatinumAsset[] = [
  { id: '1', particulars: 'Platinum Jewellery', value: 0 },
  { id: '2', particulars: 'Platinum Coins/Bars', value: 0 },
];

const Platinum: React.FC = () => {
  const [assets, setAssets] = useState<PlatinumAsset[]>(() => {
    try {
      const saved = localStorage.getItem('platinumData');
  ...
  useEffect(() => {
    localStorage.setItem('platinumData', JSON.stringify(assets));
  }, [assets]);
  ...
  const exportData = () => {
    ...
    saveAs(blob, 'platinum-data.json');
    showSuccess('Platinum data exported successfully!');
  };
  ...
  const handleClearData = () => {
    ...
    showSuccess('Platinum data values have been cleared.');
  };
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will reset all platinum asset values to zero. This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      >
        <ResizablePanel defaultSize={50}>
          <Card className="h-full border-0 shadow-none rounded-none">
            <CardHeader>
              <CardTitle>Platinum Holdings</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
